...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            Intent home = new Intent(MainActivity5.this,MainActivity1.class);
            Intent cart = new Intent(MainActivity5.this, CartActivity.class);
            AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity5.this);
            @Override
            public void onClick(View view) {
                editor.putString("ENVELO", "ENVELO");
                editor.commit();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.cart:
                Intent intent = new Intent(MainActivity5.this,CartActivity.class);
