...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            Intent home = new Intent(MainActivity4.this,MainActivity1.class);
            Intent cart = new Intent(MainActivity4.this, CartActivity.class);
            AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity4.this);
            @Override
            public void onClick(View view) {
                editor.putString("CHANEL", "CHANEL");
                editor.commit();
                ...
                builder.setPositiveButton("Keep Shopping", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        bundle1.putString("name","e");
                        home.putExtras(bundle1);
                        startActivity(home);
                    }
                });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.cart:
                Intent intent = new Intent(MainActivity4.this,CartActivity.class);
